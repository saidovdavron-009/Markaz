...
const grades = [
  { id: "1", group: "Ingliz tili A2", type: "TEST" as GradeType, score: 85, maxScore: 100, date: "2025-01-25", comment: "" },
  { id: "2", group: "Ingliz tili A2", type: "HOMEWORK" as GradeType, score: 92, maxScore: 100, date: "2025-01-24", comment: "" },
  { id: "3", group: "Speaking Club", type: "QUIZ" as GradeType, score: 78, maxScore: 100, date: "2025-01-22", comment: "" },
  { id: "4", group: "Ingliz tili A2", type: "EXAM" as GradeType, score: 88, maxScore: 100, date: "2025-01-20", comment: "Yaxshi" },
  { id: "5", group: "Ingliz tili A2", type: "HOMEWORK" as GradeType, score: 95, maxScore: 100, date: "2025-01-18", comment: "" },
  { id: "6", group: "Speaking Club", type: "TEST" as GradeType, score: 72, maxScore: 100, date: "2025-01-15", comment: "" },
  { id: "7", group: "Ingliz tili A2", type: "HOMEWORK" as GradeType, score: 80, maxScore: 100, date: "2025-01-12", comment: "" },
];
...
export default function StudentGradesPage() {
  ...
  const filtered = grades.filter(g =>
    (groupFilter === "ALL" || g.group === groupFilter) &&
  ...
  const best = filtered.reduce((best, g) => (g.score / g.maxScore > (best?.score / best?.maxScore || 0) ? g : best), filtered[0]);
